...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO penalties (resident_id, amount, date_added) VALUES ('$resident_id', '$amount', NOW())";

    if (mysqli_query($conn, $query)) {
        $addResponse = ['success', "افزودن جریمه با موفقیت انجام شد"];
    } else {
        $addResponse = ['danger', "Error: " . mysqli_error($conn)];
    }
}
$adminSidebarMenuItems['add-late-penalty']['is-active'] = true;
?>
    ...
    <div class="page-wrapper">
        ...
        <div class="main-container">
            ...
            <div class="app-container">
                ...
                <div class="app-body">
                    <form method="POST">
                        <h5 class="card-title" style="margin-bottom: 15px;">افزودن جریمه دیر کرد</h5>
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="m-0">
                                            ...
                                            <input type="number" class="form-control" id="a3" name="amount" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-sm-12 col-12">
                                <div class="card mb-12">
                                    <div class="card-body">
                                        <div class="m-0">
                                            <input type="submit" class="btn btn-primary" value="افزودن جریمه">
                                        </div>
                                    </div>
                                </div>
                            </div>
