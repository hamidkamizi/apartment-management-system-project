...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $amount = $_POST['amount'];
    $query = "INSERT INTO charges (charge_type, amount, date_added, resident_id) VALUES ('parking', '$amount', NOW(), '$resident_id')";
...
$sidebarMenuItems['pay-parking-charges']['is-active'] = true;
?>
<!DOCTYPE html>
                            ...
                            <div class="col-sm-12">
                                <div class="card mb-3">
                                    <div class="card-header">
                                        <h5 class="card-title">پرداخت شارژ پارکینگ</h5>
                                    </div>
                                    <div class="card-body">
